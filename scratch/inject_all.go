...
func main() {
  ...
  "topics": ["eu", "batteries", "ewaste", "smartphones", "regulation"]
	...
	log.Println("Successfully injected the AI summaries for the Top 3 articles into the database!")
}
